...
<body>
  <audio controls  loop autoplay style="display: none;">
    <source src="/SKPROJECT/videos_songs/freaky.mp3" type="audio/mp3">
  </audio>
...
<form  method="POST"  action="/SKPROJECT/scripts/dashboard guru/kemaskini_jawatan_db.php" autocomplete="off">

  <div class="img" >
  <img src="/SKPROJECT/images/kemaskiniajk.gif" >
 </div>
...
<span id="row2">
  ...
  <tr>
     ...
     <td width="10">
        ...
        <input type="text" name="R2C1" style="width:80px">
...
<select name ="R2C2">
  ...
  <option value="J01">Pengerusi</option>
  <option value="J02">Naib Pengerusi</option>
  <option value="J03">Bendahari</option>
  <option value="J04">Setiausaha</option>
  <option value="J05">AJK Form 5</option>
  <option value="J06">AJK Form 4</option>
  ...
  $sql = "Select count(1) FROM `JADUAL KOMPOSIT PENUH PELAJAR` WHERE `ID PELAJAR`!='0'";
...
<div class="button_form1">
      <input type="submit" value="Hantar" style="color:black;
