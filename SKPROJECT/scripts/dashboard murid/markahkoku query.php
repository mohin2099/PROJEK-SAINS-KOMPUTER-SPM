...
$sql = "SELECT * FROM `tingkatan` WHERE `Kod Tingkatan`='$Query'";


$result =  mysqli_query($connect, $sql);
$row = mysqli_fetch_array($result);

$tingkatan = $row['Nama Tingkatan'];



  //Get Data from Database using sql statement

 $sql = "SELECT * FROM `JADUAL KOMPOSIT PENUH PELAJAR` WHERE `ID PELAJAR`!='0' and `KELAS`='$tingkatan' order by `ID PELAJAR` ASC ;";
