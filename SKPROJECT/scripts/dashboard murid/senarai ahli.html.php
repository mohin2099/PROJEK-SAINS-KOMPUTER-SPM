...
<body>
  <audio controls  loop autoplay style="display: none;">
    <source src="/SKPROJECT/videos_songs/havana.mp3" type="audio/mp3">
  </audio>
...
<form action="/SKPROJECT/scripts/dashboard murid/senarai ahli query.php" method="post">
...
<!-- Code for Query -->
  ...
  <div class="search">
    <select name="query"> 
      <option>-</option>
      <optgroup label="Jantina"></optgroup>
...
<table>
  ...
  $sql = "SELECT * FROM `PELAJAR` WHERE `ID PELAJAR`!='0' order by `ID PELAJAR` ASC;";
...
<div class="Senarai_Header">
  <img src="/SKPROJECT/images/senaraiahli.gif" >
